describe('Post Search Feature - Synonyms Functionality',{ tags: '@groupTwo' }, () => {
	...
	it('Can use the Advanced Text Editor', () => {
		...
		cy.contains('.synonym-set-editor div', 'list').should(
			'exist',
		);
		cy.contains('.synonym-set-editor div', 'of').should('exist');
		cy.contains('.synonym-set-editor div', 'words').should(
			'exist',
		);
